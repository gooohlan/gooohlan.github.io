...
make all
```
![image.png](https://img.hacpai.com/file/2019/10/image-605b5c43.png)

编译成功后当前目录下的bin文件下回出现两个可执行文件
```
ls bin/
```
![image.png](https://img.hacpai.com/file/2019/10/image-6e4f4f06.png)
...
* 移除所有Navicat在钥匙链中保持的密码，可通过搜索`navacat`来找到他们
   ![image.png](https://img.hacpai.com/file/2019/10/image-b4f15694.png)
...
```
![image.png](https://img.hacpai.com/file/2019/10/image-27449b40.png)
![image.png](https://img.hacpai.com/file/2019/10/image-5c6f876b.png)
### 5. 生成一份自动签名 的代码签名证书
   * 打开钥匙串访问
   * 选择创建证书
   ...
   * 点击创建
   ...
   ![image.png](https://img.hacpai.com/file/2019/10/image-99b4f449.png)
   ![image.png](https://img.hacpai.com/file/2019/10/image-8b2aa128.png)
   ![image.png](https://img.hacpai.com/file/2019/10/image-ea68d143.png)

### 6. 签名
``` 
codesign -f -s "Navicat" /Applications/Navicat\ Premium.app/
```
![image.png](https://img.hacpai.com/file/2019/10/image-c224bb16.png)
## 激活 
...
```  
输入语言以及主版本号后会得到一个序列号  
![image.png](https://img.hacpai.com/file/2019/10/image-acf9356f.png)  
使用这个序列号来激活Navicat  
...
![image.png](https://img.hacpai.com/file/2019/10/image-0aa226c9.png)

* 一般都会激活失败，这时点击手动激活即可
  
![image.png](https://img.hacpai.com/file/2019/10/image-81692bde.png)

* 手动激活的窗口会给到你一个请求码，复制并粘贴到注册机里面，**两次回车结束输入**
  
![image.png](https://img.hacpai.com/file/2019/10/image-eaa0ba85.png)

* 不出意外的话，你会得到一个激活码，复制它并粘贴到navicat的手动激活窗口
![image.png](https://img.hacpai.com/file/2019/10/image-0b68abdb.png)   
![image.png](https://img.hacpai.com/file/2019/10/image-e8dfb932.png)
* 最后点击激活，没出问题的话就激活成功了
![image.png](https://img.hacpai.com/file/2019/10/image-d3b2e298.png)
![image.png](https://img.hacpai.com/file/2019/10/image-50a37e9d.png)
