...
categories:
  - - 技术
    - 后端
cover: 'https://cdn.inkdp.cn/img/20220731201045.png'
keywords: MySQL
abbrlink: 62506
...
- 把`%`放前面是不会使用索引的(由于版本的原因，5.6是不会使用索引的，8.0会使用，但是由于mysql的性能优化器觉得直接扫描会更快，所以没使用到)
  ...
  - 8.0：
    ...
    ![image-20220729081240244](https://cdn.inkdp.cn/img/20220729081240.png)

  - 5.6：

    ![image-20220731174559874](https://cdn.inkdp.cn/img/20220731174559.png)

- 把`%`放关键字后面，还是会走索引的

  ![image-20220729081339405](https://cdn.inkdp.cn/img/20220729081339.png)
...
- 索引列上使用mysql的内置函数，索引失效
  ...
  ![image-20220729084656162](https://cdn.inkdp.cn/img/20220729084656.png)

- 如果索引列不加内置函数，索引还是会走的

  ![image-20220729084743323](https://cdn.inkdp.cn/img/20220729084743.png)
...
- 使用!=和<>会导致扫描所有索引(5.6可以命中索引)
  ...
  - 5.6：
    ...
    ![image-20220731175351610](https://cdn.inkdp.cn/img/20220731175351.png)

  - 8.0：

    ![image-20220729143037407](https://cdn.inkdp.cn/img/20220729143037.png)
...
![image-20220729145327065](https://cdn.inkdp.cn/img/20220729145327.png)
...
![image-20220729145544327](https://cdn.inkdp.cn/img/20220729145544.png)

![image-20220729145602097](https://cdn.inkdp.cn/img/20220729145602.png)
...
![image-20220730174154876](https://cdn.inkdp.cn/img/20220730174155.png)
...
![image-20220731175901535](https://cdn.inkdp.cn/img/20220731175901.png)

正例：

![image-20220731180147538](https://cdn.inkdp.cn/img/20220731180147.png)
...
![image-20220731180958402](https://cdn.inkdp.cn/img/20220731180958.png)
...
![image-20220731195859391](https://cdn.inkdp.cn/img/20220731195859.png)
...
![image-20220731195913670](https://cdn.inkdp.cn/img/20220731195913.png)
