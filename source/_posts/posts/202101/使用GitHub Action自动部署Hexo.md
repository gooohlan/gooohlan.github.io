...
categories:
  - - 技术
    - 前端
cover: https://goohlan.fishpi.cn/img/1610127892296.png
...
* 复制`gh-pages`的内容，去仓库的`Settings -> Secrets -> Add a new secret` 页面上粘贴你的内容，`Name`字段填写为`ACTION_DEPLOY_KEY(可更改)`
  ...
  | 添加你的公钥                                                 | 成功                                                         |
  | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | ![image-20210117235120550](https://goohlan.fishpi.cn/img/image-20210117235120550.png) | ![image-20210117235147362](https://goohlan.fishpi.cn/img/image-20210117235147362.png) |

  | 添加你的私钥                                                 | 成功                                                         |
  | ------------------------------------------------------------ | ------------------------------------------------------------ |
  | ![image-20210117235828106](https://goohlan.fishpi.cn/img/image-20210117235828106.png) | ![image-20210117235912296](https://goohlan.fishpi.cn/img/image-20210117235912296.png) |
...
| 配置个人访问令牌 | 成功 |
| ---------------- | ---- |
|  ![image-20210118005047841](https://goohlan.fishpi.cn/img/image-20210118005047841.png) | ![image-20210118005143713](https://goohlan.fishpi.cn/img/image-20210118005143713.png) |
...
![image-20210118014615951](https://goohlan.fishpi.cn/img/image-20210118014615951.png)
...
- 问题1：
  ...
  ![image-20210622202346107](https://goohlan.fishpi.cn/img/20210622202346.png)
